...
function setSecurityHeaders() {
    ...
    // Content Security Policy (alternative approach)
    $csp = [
        "default-src 'self'",
        "script-src 'self' 'unsafe-inline' https://www.google.com https://www.gstatic.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://ajax.googleapis.com",
...
<head>
    ...
    <!-- Preload HSTS for better performance -->
